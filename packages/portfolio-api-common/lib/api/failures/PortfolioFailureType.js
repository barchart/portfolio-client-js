...
module.exports = (() => {
	...
	const transactionCreateFailedAfterTermination = new FailureType('TRANSACTION_CREATE_FAILED_AFTER_TERMINATION', 'Unable to process operation, one or more transactions would exist after {terminationDay}, the final day of trading for this instrument', false);
