(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.Barchart || (g.Barchart = {})).Portfolio = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"./portfolio/index":3}],2:[function(require,module,exports){
'use strict';
...
var PortfolioSchemas = require('@barchart/common-portfolio/data/serialization/json/PortfolioSchema'),
...
module.exports = function () {
  ...
  */
	...
	var PortfolioClient = function () {
		function PortfolioClient() {
			_classCallCheck(this, PortfolioClient);
		...
		_createClass(PortfolioClient, [{
			key: 'getPortfolios',
			value: function getPortfolios(user, token) {
				var _this = this;
				...
				return Promise.resolve().then(function () {
					...
					return _this._restProvider.call(_this._getPorfoliosEndpoint, { user: user }, token);
				});
			}
		}, {
			key: 'getPositions',
			value: function getPositions(user, portfolio, token) {
				var _this2 = this;
				...
				return Promise.resolve().then(function () {
					...
					return _this2._restProvider.call(_this2._getPositionsEndpoint, { user: user, portfolio: portfolio }, token);
				});
			}
		}, {
			key: 'getTransactions',
			value: function getTransactions(user, portfolio, position, token) {
				var _this3 = this;
				...
				return Promise.resolve().then(function () {
					...
					return _this3._restProvider.call(_this3._getTransactionsEndpoint, { user: user, portfolio: portfolio, position: position }, token);
				});
			}
		}, {
			key: 'getDisplayTransactions',
			value: function getDisplayTransactions(user, portfolio, position, token) {
				var _this4 = this;
				...
				return Promise.resolve().then(function () {
					...
					return _this4._restProvider.call(_this4._getTransactionsDisplayEndpoint, { user: user, portfolio: portfolio, position: position }, token);
				});
			}
		}, {
			key: 'getLegacyPortfolios',
			value: function getLegacyPortfolios(user, token) {
				var _this5 = this;
				...
				return Promise.resolve().then(function () {
					...
					return _this5._restProvider.call(_this5._getLegacyPortfoliosEndpoint, { user: user }, token);
				});
			}
...
},{"@barchart/common-js/lang/assert":15,"@barchart/common-js/lang/connection":17,"@barchart/common-js/lang/is":19,"@barchart/common-js/network/rest/RestAction":22,"@barchart/common-js/network/rest/RestEndpoint":23,"@barchart/common-js/network/rest/RestParser":24,"@barchart/common-js/network/rest/browser/XhrRestProvider":26,"@barchart/common-portfolio/data/serialization/json/PortfolioSchema":35,"@barchart/common-portfolio/data/serialization/json/PositionSchema":36,"@barchart/common-portfolio/data/serialization/json/TransactionSchema":37}],3:[function(require,module,exports){
'use strict';

var PortfolioClient = require('./PortfolioClient');
...
},{"./PortfolioClient":2}],4:[function(require,module,exports){
'use strict';
...
},{"./../../lang/assert":15,"./comparators":7}],7:[function(require,module,exports){
'use strict';
...
},{"./Enum":11,"./assert":15,"./is":19}],9:[function(require,module,exports){
'use strict';
...
},{"./../collections/sorting/ComparatorBuilder":6,"./../collections/sorting/comparators":7,"./assert":15,"./is":19}],10:[function(require,module,exports){
'use strict';
...
},{"./Enum":11,"./assert":15,"./is":19,"big.js":38}],11:[function(require,module,exports){
'use strict';
...
},{"./Currency":8,"./Decimal":10,"./assert":15,"./is":19}],13:[function(require,module,exports){
'use strict';
...
},{"./assert":15,"./is":19,"moment-timezone":44}],14:[function(require,module,exports){
'use strict';
...
},{"./Enum":11,"./assert":15,"./timezone":21}],15:[function(require,module,exports){
'use strict';
...
},{"./assert":15,"./is":19}],17:[function(require,module,exports){
'use strict';
...
},{"./assert":15,"moment-timezone/builds/moment-timezone-with-data-2010-2020":42}],22:[function(require,module,exports){
'use strict';
...
},{"./../../lang/Enum":11,"./../../lang/assert":15}],23:[function(require,module,exports){
'use strict';
...
},{"./../../lang/assert":15,"./../../lang/attributes":16,"./../../lang/is":19,"./RestAction":22,"./RestParser":24}],24:[function(require,module,exports){
'use strict';
...
},{"./../../lang/assert":15,"./../../serialization/json/Schema":30,"./RestEndpoint":23,"./RestParser":24}],25:[function(require,module,exports){
'use strict';
...
},{"./../../lang/assert":15,"./RestEndpoint":23,"./RestParser":24}],26:[function(require,module,exports){
'use strict';
...
},{"./../../../lang/is":19,"./../../../lang/promise":20,"./../RestProviderBase":25,"xhr":49}],27:[function(require,module,exports){
'use strict';
...
},{"./../../lang/Currency":8,"./../../lang/Money":12,"./DataType":28,"./Field":29}],28:[function(require,module,exports){
'use strict';
...
},{"./../../lang/Day":9,"./../../lang/Decimal":10,"./../../lang/Enum":11,"./../../lang/Timestamp":13,"./../../lang/assert":15,"./../../lang/is":19}],29:[function(require,module,exports){
'use strict';
...
},{"./../../collections/LinkedList":4,"./../../collections/Tree":5,"./../../lang/assert":15,"./../../lang/functions":18,"./../../lang/is":19,"./Component":27,"./Field":29}],31:[function(require,module,exports){
'use strict';
...
},{"./../../../lang/assert":15,"./../Component":27,"./../DataType":28,"./../Field":29}],32:[function(require,module,exports){
'use strict';
...
},{"./../../../lang/assert":15,"./../../../lang/is":19,"./../Component":27,"./../DataType":28,"./../Field":29,"./../Schema":30,"./ComponentBuilder":31}],33:[function(require,module,exports){
...
},{"@barchart/common-js/lang/Enum":11,"@barchart/common-js/lang/assert":15}],34:[function(require,module,exports){
const assert = require('@barchart/common-js/lang/assert'),
	Enum = require('@barchart/common-js/lang/Enum');
...
},{"@barchart/common-js/lang/Enum":11,"@barchart/common-js/lang/assert":15}],35:[function(require,module,exports){
const assert = require('@barchart/common-js/lang/assert'),
...
},{"./../../ValuationType":34,"@barchart/common-js/lang/Currency":8,"@barchart/common-js/lang/Enum":11,"@barchart/common-js/lang/Timezones":14,"@barchart/common-js/lang/assert":15,"@barchart/common-js/lang/is":19,"@barchart/common-js/serialization/json/DataType":28,"@barchart/common-js/serialization/json/builders/SchemaBuilder":32}],36:[function(require,module,exports){
const assert = require('@barchart/common-js/lang/assert'),
	Currency = require('@barchart/common-js/lang/Currency'),
	DataType = require('@barchart/common-js/serialization/json/DataType'),
	Enum = require('@barchart/common-js/lang/Enum'),
...
},{"./../../ValuationType":34,"@barchart/common-js/lang/Currency":8,"@barchart/common-js/lang/Enum":11,"@barchart/common-js/lang/assert":15,"@barchart/common-js/lang/is":19,"@barchart/common-js/serialization/json/DataType":28,"@barchart/common-js/serialization/json/builders/SchemaBuilder":32}],37:[function(require,module,exports){
const assert = require('@barchart/common-js/lang/assert'),
	Currency = require('@barchart/common-js/lang/Currency'),
	DataType = require('@barchart/common-js/serialization/json/DataType'),
	Enum = require('@barchart/common-js/lang/Enum'),
...
},{"./../../TransactionType":33,"@barchart/common-js/lang/Currency":8,"@barchart/common-js/lang/Enum":11,"@barchart/common-js/lang/assert":15,"@barchart/common-js/serialization/json/DataType":28,"@barchart/common-js/serialization/json/builders/SchemaBuilder":32}],38:[function(require,module,exports){
...
},{"moment":46}],43:[function(require,module,exports){
module.exports={
	"version": "2016j",
	"zones": [
...
},{"for-each":39,"trim":48}],48:[function(require,module,exports){
...
},{"global/window":40,"is-function":41,"parse-headers":47,"xtend":50}],50:[function(require,module,exports){
