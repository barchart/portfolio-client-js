...
module.exports = (() => {
	...
	/**
	 * Creates a {@link TransactionType.DIVIDEND_REINVEST} transaction.
	 *
	 * @public
	 * @extends {Create}
	 * @param {Object} data
	 ...
	 * @param {Decimal} data.price - The share price value to used to convert the cash dividend into shares.
	 */
	class DividendReinvest extends Create {
		constructor(data) {
			super(data);
