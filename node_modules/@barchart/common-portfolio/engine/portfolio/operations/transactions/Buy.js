...
module.exports = (() => {
	...
	/**
	 * Creates a {@link TransactionType.BUY} transaction.
	 *
	 * @public
	 * @extends {Create}
	 * @param {Object} data
	...
	class Buy extends Create {
		...
		_afterTransactionCreated(position, transactions, transaction) {
			...
			data.description = `Buy ${transaction.quantity.toFixed()} ${getDescriptionForInstrument(position.instrument)} @ ${transaction.trade.price.toFixed()}`;
