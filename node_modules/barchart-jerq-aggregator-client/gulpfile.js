...
gulp.task('commit-changes', function () {
	return gulp.src([ './', './dist/', './test/dist/', './package.json', './bower.json', './lib/index.js' ])
		.pipe(git.add())
...
gulp.task('build-browser', function () {
	return browserify('./lib/index.js', {standalone: 'Barchart.StreamingData'})
		.bundle()
		.pipe(source('barchart-jerq-aggregator-api-' + getVersionForComponent() + '.js'))
		.pipe(buffer())
		.pipe(gulp.dest('./dist'))
		.pipe(uglify())
		.pipe(rename('barchart-jerq-aggregator-api-' + getVersionForComponent() + '-min.js'))
		.pipe(gulp.dest('dist/'));
});
...
gulp.task('build-browser-tests', function () {
	return browserify({entries: glob.sync('test/specs/**/*.js')})
		...
		.bundle()
		.pipe(source('barchart-jerq-aggregator-api-tests-' + getVersionForComponent() + '.js'))
		.pipe(buffer())
		.pipe(gulp.dest('test/dist'));
});

gulp.task('execute-browser-tests', function () {
	return gulp.src('test/dist/barchart-jerq-aggregator-api-tests-' + getVersionForComponent() + '.js')
		.pipe(jasmine());
});
