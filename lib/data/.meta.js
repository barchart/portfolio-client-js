 ...
 * @type Object
 * @memberOf Schema
 * @property {Boolean=} cash - Indicates if corresponding cash transactions should be created, as appropriate (e.g. also DEBIT cash when creating a BUY transaction for stock).
 ...
 * @property {ValuationType=} valuation - The strategy for determining position cost basis and calculating gains and losses.
 */
