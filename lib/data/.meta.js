...
/**
 * @ignore
 * @typedef SnapTradeConnectionInitialization
 * @type {Object}
 * @memberOf Schema
 ...
 * @property {SnapTradeBrokerageMeta} meta - Metadata regarding the brokerage.
 * @property {SnapTradeBrokerageUser} meta - Metadata regarding the brokerage.
 */

/**
 * @ignore
 * @typedef SnapTradeBrokerageUser
 * @type {Object}
 * @memberOf Schema
 * @property {String} user - The user identifier.
 * @property {Boolean} connected - Indicates if there is a connection for the brokerage.
 */
 ...
 * @property {String} name - The name of the brokerage.
 * @property {String} display - The name of the brokerage (for display to a user).
 * @property {String} enabled - When false, the user needs to authenticate again (before any data can be read).
 * @property {SnapTradeBrokerageMeta} meta - Metadata regarding the brokerage.
 * @property {SnapTradeAccount[]} accounts - A list of accounts (which can be associated with portfolios),
 */

/**
 * @ignore
 * @typedef SnapTradeBrokerageMeta
 * @type {Object}
 * @memberOf Schema
 * @property {String} logo - The URL for an square logo image.
 * @property {String} url - The URL for the brokerage.
 */
 ...
 * @property {String} nane - The account name.
 * @property {String} type - The account type.
 * @property {String|null} portfolio - The identifier of the linked portfolio. When null, no portfolio has been linked.
 */