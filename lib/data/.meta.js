 ...
 * @property {AdHoc=} miscellany - Miscellaneous data regarding the portfolio.
 * @property {Schema.PortfolioDates} - Important days and timestamps for the portfolio.
 * @property {Schema.PortfolioDefaults} defaults - Default settings for the portfolio.
 * @property {Schema.PortfolioLegacyData=} legacy - Correlation identifiers from an external (consumer) system.
 */
...
/**
 * An object containing important days and timestamps related to a portfolio.
 *
 * @typedef PortfolioDates
 * @type Object
 * @memberOf Schema
 * @property {Day} create - The day the portfolio was created.
 * @property {Timestamp} access - The timestamp when the portfolio was last accessed.
 */

/**
 * An object defining default behavior for positions added to the portfolio.
 *
 * @typedef PortfolioDefaults
 * @type Object
 * @memberOf Schema
 * @property {Boolean=} cash - Controls whether cash transactions will be automatically be generated for investment transactions (e.g. will a cash DEBIT transaction be created when a stock BUY transaction is entered).
 * @property {Currency=} currency - The currency used for top-level summarization and reporting.
 * @property {Boolean=} reinvest - Controls whether dividends will be automatically reinvested.
 * @property {ValuationType=} valuation - Determines the strategy for determining cost bases and gains.
 */

/**
 * An object external user identifiers.
 *
 * @typedef PortfolioLegacyData
 * @type Object
 * @memberOf Schema
 * @property {String} system - The name of the external system.
 * @property {String} user - The user identifier of the portfolio identifier in the external system.
 */
 ...
 * @property {UnitCode=} code - The unit code of the exchange (if available).
 * @property {Currency} currency - The currency used to trade (or value) the instrument (e.g. USD).
 * @property {String=} exchange - The listing exchange for the instrument (if available).
 ...
 * @property {PositionDirection} initial - The direction of the position immediately after it was opened.
 */
 ...
 * @property {String=} type - The code of the asset class. See the InstrumentType enumeration in the @barchart/portfolio-api-common library.
 * @property {Number=} code - The numeric code of the asset class. See the InstrumentType enumeration in the @barchart/portfolio-api-common library.
