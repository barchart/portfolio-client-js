 ...
 * @property {SnapTradeConnection=} connection
 ...
 * @type {Object}
 * @memberOf Schema
 * @property {String=} portfolio - The portfolio identifier (not included when used as an attribute of a portfolio).
